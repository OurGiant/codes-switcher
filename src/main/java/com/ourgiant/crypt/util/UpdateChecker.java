package com.ourgiant.crypt.util;
...
/** Checks GitHub's releases API for a newer Codes Switcher version. This is the app's only outbound network call. */
public final class UpdateChecker {
    private static final Logger logger = LoggerFactory.getLogger(UpdateChecker.class);
    private static final String RELEASES_URL = "https://api.github.com/repos/OurGiant/codes-switcher/releases/latest";
    ...
    public static Optional<ReleaseInfo> fetchLatestRelease() {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                ...
                .header("User-Agent", "codes-switcher")
